    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold text-brand-text-primary">Prefacturado Orders</h1>
                <ExportControls data={prefacturadoEntries} columns={exportColumns} fileName="prefacturado_orders" />
            </div>
